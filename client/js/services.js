  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Song.votes.findById() instead.
        "prototype$__findById__votes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/songs/:id/votes/:fk",
          method: "GET"
        },

        // INTERNAL. Use Song.votes.destroyById() instead.
        ...
        // INTERNAL. Use Song.votes.updateById() instead.
        ...
        // INTERNAL. Use Song.votes() instead.
        "prototype$__get__votes": {
          isArray: true,
          url: urlBase + "/songs/:id/votes",
          method: "GET"
        },

        // INTERNAL. Use Song.votes.create() instead.
        "prototype$__create__votes": {
          url: urlBase + "/songs/:id/votes",
          method: "POST"
        },

        // INTERNAL. Use Song.votes.destroyAll() instead.
        "prototype$__delete__votes": {
          url: urlBase + "/songs/:id/votes",
          method: "DELETE"
        },

        // INTERNAL. Use Song.votes.count() instead.
        "prototype$__count__votes": {
          url: urlBase + "/songs/:id/votes/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Vote.songId() instead.
        "::get::Vote::songId": {
          url: urlBase + "/votes/:id/songId",
          method: "GET"
        },
      }
    );
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Song.votes
     * @header lbServices.Song.votes
     * @object
     * @description
     *
     * The object `Song.votes` groups methods
     * manipulating `Vote` instances related to `Song`.
     *
     * Call {@link lbServices.Song#votes Song.votes()}
     * to query all related instances.
     */
        ...
        R.votes = function() {
          ...
          var action = TargetResource["::get::Song::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Song.votes#count
         * @methodOf lbServices.Song.votes
         *
         * @description
         *
         * Counts votes of Song.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.votes.count = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::count::Song::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Song.votes#create
         * @methodOf lbServices.Song.votes
         *
         * @description
         *
        ...
        R.votes.create = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::create::Song::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Song.votes#createMany
         * @methodOf lbServices.Song.votes
         *
         * @description
         *
        ...
        R.votes.createMany = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::createMany::Song::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Song.votes#destroyAll
         * @methodOf lbServices.Song.votes
         *
         * @description
         *
        ...
        R.votes.destroyAll = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::delete::Song::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Song.votes#destroyById
         * @methodOf lbServices.Song.votes
         *
         * @description
         *
        ...
        R.votes.destroyById = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::destroyById::Song::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Song.votes#findById
         * @methodOf lbServices.Song.votes
         *
         * @description
         *
        ...
        R.votes.findById = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::findById::Song::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Song.votes#updateById
         * @methodOf lbServices.Song.votes
         *
         * @description
         *
        ...
        R.votes.updateById = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::updateById::Song::votes"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Vote.songId() instead.
        "prototype$__get__songId": {
          url: urlBase + "/votes/:id/songId",
          method: "GET"
        },

        // INTERNAL. Use Vote.voter() instead.
        "prototype$__get__voter": {
          url: urlBase + "/votes/:id/voter",
          method: "GET"
        },
        ...
        // INTERNAL. Use Song.votes.createMany() instead.
        "::createMany::Song::votes": {
          isArray: true,
          url: urlBase + "/songs/:id/votes",
          method: "POST"
        },
        ...
        // INTERNAL. Use Voter.votes.findById() instead.
        "::findById::Voter::votes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/voters/:id/votes/:fk",
          method: "GET"
        },

        // INTERNAL. Use Voter.votes.destroyById() instead.
        "::destroyById::Voter::votes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/voters/:id/votes/:fk",
        ...
        // INTERNAL. Use Voter.votes.updateById() instead.
        "::updateById::Voter::votes": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/voters/:id/votes/:fk",
        ...
        // INTERNAL. Use Voter.votes() instead.
        "::get::Voter::votes": {
          isArray: true,
          url: urlBase + "/voters/:id/votes",
          method: "GET"
        },

        // INTERNAL. Use Voter.votes.create() instead.
        "::create::Voter::votes": {
          url: urlBase + "/voters/:id/votes",
          method: "POST"
        },

        // INTERNAL. Use Voter.votes.createMany() instead.
        "::createMany::Voter::votes": {
          isArray: true,
          url: urlBase + "/voters/:id/votes",
          method: "POST"
        },

        // INTERNAL. Use Voter.votes.destroyAll() instead.
        "::delete::Voter::votes": {
          url: urlBase + "/voters/:id/votes",
          method: "DELETE"
        },

        // INTERNAL. Use Voter.votes.count() instead.
        "::count::Voter::votes": {
          url: urlBase + "/voters/:id/votes/count",
          method: "GET"
        },
      }
    );
    ...
    */
    R.modelName = "Vote";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Vote#songId
         * @methodOf lbServices.Vote
         *
         * @description
         *
         * Fetches belongsTo relation songId.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.songId = function() {
          ...
          var action = TargetResource["::get::Vote::songId"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Vote#voter
         * @methodOf lbServices.Vote
         *
         * @description
         *
         ...
         */
        R.voter = function() {
          var TargetResource = $injector.get("Voter");
          var action = TargetResource["::get::Vote::voter"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Voter
 * @header lbServices.Voter
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Voter` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#prototype$__findById__accessTokens
         * @methodOf lbServices.Voter
         *
         * @description
         *
         * Find a related item by id for accessTokens.
        ...
        "prototype$__findById__accessTokens": {
          ...
          url: urlBase + "/voters/:id/accessTokens/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#prototype$__destroyById__accessTokens
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#prototype$__updateById__accessTokens
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#prototype$__get__accessTokens
         * @methodOf lbServices.Voter
         *
         * @description
         *
         * Queries accessTokens of Voter.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__get__accessTokens": {
          isArray: true,
          url: urlBase + "/voters/:id/accessTokens",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#prototype$__create__accessTokens
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#prototype$__delete__accessTokens
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#prototype$__count__accessTokens
         * @methodOf lbServices.Voter
         *
         * @description
         *
         * Counts accessTokens of Voter.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         */
        "prototype$__count__accessTokens": {
          url: urlBase + "/voters/:id/accessTokens/count",
          method: "GET"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#createMany
         * @methodOf lbServices.Voter
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/voters/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#findById
         * @methodOf lbServices.Voter
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/voters/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#find
         * @methodOf lbServices.Voter
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/voters/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#updateAll
         * @methodOf lbServices.Voter
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/voters/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#deleteById
         * @methodOf lbServices.Voter
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/voters/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#prototype$updateAttributes
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#createChangeStream
         * @methodOf lbServices.Voter
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/voters/change-stream",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#login
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        "login": {
          ...
          url: urlBase + "/voters/login",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#logout
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        "logout": {
          ...
          url: urlBase + "/voters/logout",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#confirm
         * @methodOf lbServices.Voter
         *
         * @description
         *
         ...
         */
        "confirm": {
          url: urlBase + "/voters/confirm",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Voter#resetPassword
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#getCurrent
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#updateOrCreate
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#destroyById
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#removeById
         * @methodOf lbServices.Voter
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#getCachedCurrent
         * @methodOf lbServices.Voter
         *
         * @description
         *
         * Get data of the currently logged user that was returned by the last
         * call to {@link lbServices.Voter#login} or
         * {@link lbServices.Voter#getCurrent}. Return null when there
         * is no user logged in or the data of the current user were not fetched
         * yet.
         *
         * @returns {Object} A Voter instance.
         */
        R.getCachedCurrent = function() {
          var data = LoopBackAuth.currentUserData;
          return data ? new R(data) : null;
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#isAuthenticated
         * @methodOf lbServices.Voter
         *
         * @returns {boolean} True if the current user is authenticated (logged in).
         */
        ...
        /**
         * @ngdoc method
         * @name lbServices.Voter#getCurrentId
         * @methodOf lbServices.Voter
         *
         * @returns {Object} Id of the currently logged-in user or null.
         */
    ...
    /**
    * @ngdoc property
    * @name lbServices.Voter#modelName
    * @propertyOf lbServices.Voter
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Voter`.
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Voter.votes
     * @header lbServices.Voter.votes
     * @object
     * @description
     *
     * The object `Voter.votes` groups methods
     * manipulating `Vote` instances related to `Voter`.
     *
     * Call {@link lbServices.Voter#votes Voter.votes()}
     * to query all related instances.
     */
        ...
        R.votes = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::get::Voter::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Voter.votes#count
         * @methodOf lbServices.Voter.votes
         *
         * @description
         *
         * Counts votes of Voter.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        R.votes.count = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::count::Voter::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Voter.votes#create
         * @methodOf lbServices.Voter.votes
         *
         * @description
         *
        ...
        R.votes.create = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::create::Voter::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Voter.votes#createMany
         * @methodOf lbServices.Voter.votes
         *
         * @description
         *
        ...
        R.votes.createMany = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::createMany::Voter::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Voter.votes#destroyAll
         * @methodOf lbServices.Voter.votes
         *
         * @description
         *
        ...
        R.votes.destroyAll = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::delete::Voter::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Voter.votes#destroyById
         * @methodOf lbServices.Voter.votes
         *
         * @description
         *
        ...
        R.votes.destroyById = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::destroyById::Voter::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Voter.votes#findById
         * @methodOf lbServices.Voter.votes
         *
         * @description
         *
        ...
        R.votes.findById = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::findById::Voter::votes"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Voter.votes#updateById
         * @methodOf lbServices.Voter.votes
         *
         * @description
         *
        ...
        R.votes.updateById = function() {
          var TargetResource = $injector.get("Vote");
          var action = TargetResource["::updateById::Voter::votes"];
          return action.apply(R, arguments);
        };
